...
const HomePage = () => {
    ...
    const [lang] = useState(getCurrentLang());
    ...
    const validateAndSaveKey = async () => {
        ...
        if (isValid) {
            ...
            alert(lang === 'ar' ? "فشل التحقق من المفتاح! ✨" : "Hmm, my heart couldn't verify that key. Please check it and try again! ✨");
        }
    ...
    return (
        <div className="h-full w-full relative flex flex-col bg-slate-50 overflow-hidden font-sans" dir={rtl ? 'rtl' : 'ltr'}>
            ...
            <div className="relative flex-1 flex flex-col items-center justify-center px-8 text-center">
                ...
                <motion.button
                    ...
                    className="group relative px-12 py-5 bg-brand-indigo text-white rounded-[2rem] overflow-hidden shadow-2xl shadow-indigo-100 transition-all font-black"
                >
                ...
                {onboardingStep && (
                    ...
                    >
                        {onboardingStep === 'api' ? (
                            ...
                            >
                                <div className={`absolute top-0 ${rtl ? 'left-0' : 'right-0'} p-6 opacity-10`}>
                                    <Settings size={80} className="rotate-12" />
                                </div>

                                <h3 className="text-2xl font-black text-slate-900 mb-2">{t.powerMeUp}</h3>
                                ...
                                <div className="space-y-4 mb-8">
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <p className="text-[11px] text-slate-400 font-medium">{t.step2}</p>
                                    </div>
                                    <div className="flex items-start gap-3">
                                        ...
                                        <p className="text-[11px] text-slate-400 font-medium">{t.step3}</p>
                                    </div>
                                </div>
                                ...
                                >
                                    {isValidating ? t.validating : t.unlockPotential}
                                </motion.button>
                            ...
                            >
                                ...
                                <h3 className="text-2xl font-black text-slate-900 mb-2">{t.stayClose}</h3>
